...
const createTourSchema = z.object({
    ...
    is_group_tour: z.boolean().optional(),
    physical_rating: z.string().optional(),
    min_age: z.number().optional(),
    group_max_pax: z.number().optional(),
    inclusions_html: z.string().optional(),
    exclusions_html: z.string().optional(),
    packing_list_html: z.string().optional(),
    visa_info_html: z.string().optional(),
