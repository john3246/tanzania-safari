...
(
    ...
    sender_id uuid,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT booking_communications_pkey PRIMARY KEY (communication_id)
);
...
(
    ...
    payment_status character varying(50) COLLATE pg_catalog."default" DEFAULT 'completed'::character varying,
...
(
    ...
    CONSTRAINT tour_categories_slug_key UNIQUE (slug)
);
...
ALTER TABLE IF EXISTS public.booking_communications
    ADD CONSTRAINT booking_communications_booking_id_fkey FOREIGN KEY (booking_id)
...
ALTER TABLE IF EXISTS public.booking_communications
    ADD CONSTRAINT booking_communications_sender_id_fkey FOREIGN KEY (sender_id)
    REFERENCES public.users (user_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS public.booking_payments
    ADD CONSTRAINT booking_payments_booking_id_fkey FOREIGN KEY (booking_id)
    REFERENCES public.bookings (booking_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.tours
    ADD CONSTRAINT tours_category_id_fkey FOREIGN KEY (category_id)
    REFERENCES public.tour_categories (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;


ALTER TABLE IF EXISTS public.tours
    ADD CONSTRAINT tours_destination_id_fkey FOREIGN KEY (destination_id)
