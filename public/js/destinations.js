    ...
    try {
        ...
        <a href="/destinations/${d.park_slug}" class="dest-card group">
          <div class="dest-card-img-wrapper">
              <img src="${(d.image_urls && d.image_urls.length > 0) ? d.image_urls[0] : (d.image_url || '/images/optimized/balloon.webp')}" alt="${d.park_name}" loading="lazy" decoding="async" class="group-hover:scale-110 transition-transform duration-700">
