    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0;">
        ...
        <div style="padding: 30px; background-color: #ffffff;">
          <h2 style="color: #0D47A1; margin-top: 0;">Your Safari Booking is Under Review</h2>
          <p style="color: #333; line-height: 1.6;">Hi ${booking.customer_name || 'Traveler'},</p>
          <p style="color: #333; line-height: 1.6;">Thank you for booking with Tanzania Safari Magic. We have received your booking request and our team is currently reviewing it. Here is a summary of your requested trip:</p>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0;">
        ...
        <div style="padding: 30px; background-color: #ffffff;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tr>
              <td style="padding: 10px; border: 1px solid #eee; background-color: #f9f9f9; font-weight: bold; color: #0D47A1;">Total Cost</td>
